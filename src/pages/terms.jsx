  ...
  return (
    <div className="flex max-w-7xl mx-auto p-6 sm:p-10 bg-white text-gray-800">
      ...
      <main className="flex-1 space-y-6">
        ...
        <p>
          Welcome to <strong>CellPe</strong>. Your use of CellPe on our Website or Mobile App 
          ...
          of at least 18 years of age. CellPe reserves the right, at its sole discretion,
        ...
        <p>
          ...
          under which you’re allowed to use the website and how we’ll treat your account and CellPe while
          you are a member.
        </p>
        ...
        <p>
          ...
          <a
            href="mailto:officialcellpe@gmail.com"
        ...
        <section id="acceptance">
          ...
          <ul className="list-disc list-outside mt-4 mb-6 pl-5">
            <li>
                ...
                that CellPe will treat your use of the Services as acceptance of the Terms from that point onwards.
            </li>
            <li>
                For being a valid User, you must satisfy the following condition: You are of legal age to form 
                a binding contract with CellPe, or you are not a person barred from receiving the Services under
        ...
        <section id="eligibility">
          ...
          <p>
            ...
            or removed from the services by CellPe. By accepting these Terms & Conditions or by otherwise 
            ...
            account or your use of CellPe if any information provided by you is false, fictitious, 
        ...
        <section id="recharges">
          ...
          <p>
            We are a Reseller Only. CellPe does not provide mobile service and is only a reseller 
            of prepaid mobile services by telecommunications service providers or the providers of 
            such prepaid recharge. CellPe is not a warrantor, insurer, or guarantor of the services to be 
        ...
        <section id="general">
          <p className="text-lg font-bold text-gray-700 mt-8 mb-4">5. General Conditions</p>
          <ul className="list-disc list-inside mb-6">
            ...
            <li>
              CellPe is not liable for ment delays due to reasons beyond our control.
            </li>
          </ul>
        </section>
        ...
        <section id="confidentiality">
          ...
          <p>Privacy of communication is subject to the terms of the certificate of authorization 
            ...
            in order to facilitate the provision of CellPe Wallet, CellPe may be required to 
        ...
        <section id="ip">
          ...
          <p>As between you and CellPe, all Materials, trademarks, service marks, and trade names contained 
            on the Site are the property of CellPe and/or third-party licensors or suppliers. You shall not 
            ...
            competing product. Unauthorized use is strictly prohibited. All rights are expressly reserved to CELLPE.
          </p>
        </section>

        <section id="disclaimer">
          <h2 className="text-lg font-bold text-gray-700 mt-8 mb-4">8. Disclaimer (No Warranty)</h2>
          <p>CellPe makes no warranty, express or implied, with respect to the Site and Related Applications 
            and Services offered. CellPe expressly disclaims the implied warranties of non-infringement, 
            merchantability, and fitness for any particular purpose. CellPe provides the Site and Related 
            ...
            and you should not rely on any such statement. In no event will CellPe be liable for any incidental, 
        ...
        <section id="indemnity">
          ...
          <p>You agree to indemnify, defend, and hold CellPe and/or related parties harmless from any 
            and all claims, losses, damages, and liabilities, costs, and expenses, including and without 
            limitation legal fees and expenses, arising out of or related to your use or misuse of CellPe, 
        ...
        <section id="liability">
          ...
          <p>Not withstanding anything to the contrary contained herein, neither CellPe, nor its affiliated 
        ...
        <section id="authorization">
          ...
          <p>
            CellPe reserves the right to change, modify, add, or remove portions of this Agreement 
            ...
            Your authorization will remain in full force and effect until your CellPe account is closed or terminated.
          </p>
        </section>
        ...
        <section id="refund">
          ...
          <p>All sales are final with no refund or exchange permitted. You are responsible for the information 
            you provide for the purchase and all charges that result from those purchases. CellPe is not responsible 
            for any purchase of incorrect information provided. If in a transaction performed by you on the Site, 
            money has been charged to your CellPe wallet, credit/debit card, or bank account, and recharge is not 
            delivered within two hours of your completion of the transaction, then you may inform us by sending 
            an email to our customer services email address as mentioned. CellPe shall investigate the incident, 
            and if it is found that money was charged to your CellPe wallet, credit/debit card, or bank account 
            without delivery of the recharge, then you will be refunded the money within 7 working days from the 
            date of receipt of your email. All refunds will be credited to your CellPe account.
          </p>
        </section>

        <section id="technical">
          <h2 className="text-lg font-bold text-gray-700 mt-8 mb-4">13. Technical Issues</h2>
          <p>
            In case of any technical issues, please raise a support ticket by emailing{" "}
            <a
              href="mailto:offcialcellpe@gmail.com"
              className="text-teal-600 hover:underline"
            >
              Officialcellpe@gmail.com
            </a>
        ...
        <section id="law">
          <h2 className="text-lg font-bold text-gray-700 mt-8 mb-4">14. Governing Law & Dispute Resolution</h2>
          <p>The Terms will be governed by and construed in accordance with the laws of India. 
        ...
        <section id="communication">
          ...
          <p>
            Customer also agrees to receive information regarding what CellPe perceives to be of their interest 
